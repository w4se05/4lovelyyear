...
> 
> - I installed TikZJax, Content inside of tikz code blocks will be rendered by TikZJax. Remember to load any packages you need with \usepackage{}, and include \begin{document} and \end{document}. The standalone document class is used (\documentclass{standalone}). Example:
