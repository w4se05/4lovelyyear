...
### Tables after removing 17, 44 and 77
...
**Linear probing** (slot 6 now holds 43):
...
| 2   | 6    | 43    |
| 3   | 7    | 30    |
| 4   | 8    | **—** (None) → insert here |

→ **5 probes**, placed at slot **8**

**Quadratic probing** (slot 3 now holds 43):
...
| 4   | 11   | 102   |
| 5   | 3    | 43    |
| 6   | $(4+73)\bmod 13=12$ | **DEL** → insert here |

→ **7 probes**, placed at slot **12**

**Double hashing** (slot 10 now holds 43):
...
| e    | Insert 43 (after removing 44,77) | 3      | 6         | 2      |
| f    | Insert 56 (after part e)         | 5      | 7         | 4      |
